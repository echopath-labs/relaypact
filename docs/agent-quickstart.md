...
This tutorial covers the v0.3.6 Codex capsule tooling. Its
...
- This guide targets `v0.3.6`; `v0.1.2` and `v0.1.1` remain available.
...
## Minute 1: install and verify the v0.3.6 release
...
the peeled v0.3.6 tag commit. Verify package.json and plugin.json both report 0.3.6; read README.md
