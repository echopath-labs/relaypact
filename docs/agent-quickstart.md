...
This tutorial covers the v0.3.2 Codex capsule tooling. Its
...
- This guide targets `v0.3.2`; `v0.1.2` and `v0.1.1` remain available.
...
## Minute 1: install and verify the v0.3.2 release
...
the peeled v0.3.2 tag commit. Verify package.json and plugin.json both report 0.3.2; read README.md
